<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="ViewBook.aspx.cs" Inherits="New_Projekt.ViewBook" %>
                                                    ...
                                                    <ItemTemplate>
                                                      ...
                                                      Language -<span>&nbsp;</span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            Description -
                                                                            <asp:Label ID="Label13" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Smaller" Text='<%# Eval("book_descreption") %>'></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
